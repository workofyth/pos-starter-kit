...
export default function Home() {
  ...
  if (session) {
    return null; // Prevent rendering the home page if user is already authenticated
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <main className="container mx-auto px-4 sm:px-6 pb-12 sm:pb-8 max-w-5xl">
        ...
        <div className="text-center mb-8">
          ...
          <div className="font-bold text-lg sm:text-xl mb-2">Complete POS Solution</div>
          <div className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
            This project includes everything you need to build a modern POS system with TypeScript, 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          ...
          <Card className="p-4 sm:p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10 border-blue-200/50 dark:border-blue-700/30">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold text-lg">POS Features</h3>
            </div>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• <strong>Point of Sale</strong> - Real-time transaction processing</li>
              <li>• <strong>Inventory Management</strong> - Track stock levels</li>
              <li>• <strong>Multi-Branch</strong> - Manage multiple locations</li>
              <li>• <strong>Member System</strong> - Loyalty and points</li>
            </ul>
          </Card>
          ...
          <Card className="p-4 sm:p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/10 dark:to-emerald-900/10 border-green-200/50 dark:border-green-700/30">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>• <strong>Role-Based Access</strong> - Cashier, Manager, Admin</li>
          ...
          <Card className="p-4 sm:p-6 bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/10 dark:to-blue-900/10 border-cyan-200/50 dark:border-cyan-700/30">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>• <strong>Multi-Tenant</strong> - Support for multiple branches</li>
            </ul>
          </Card>
          ...
          <Card className="p-4 sm:p-6 bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/10 dark:to-red-900/10 border-orange-200/50 dark:border-orange-700/30">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• <strong>Sales Reports</strong> - Daily, weekly, monthly</li>
              <li>• <strong>Inventory Reports</strong> - Low stock, dead stock</li>
              <li>• <strong>Financial Reports</strong> - Profit & loss statements</li>
              <li>• <strong>Export Data</strong> - Excel, PDF formats</li>
            </ul>
          </Card>
          ...
          <Card className="p-4 sm:p-6 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/10 dark:to-purple-900/10 border-indigo-200/50 dark:border-indigo-700/30">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• <strong>POS Interface</strong> - User-friendly cash register</li>
              <li>• <strong>Data Visualization</strong> - Recharts integration</li>
              <li>• <strong>Barcode Scanner</strong> - Product lookup</li>
